...
def main():
    ...
    model_path = "./llama-2-7b-chat-hukka-hua4"
    
    # model_path = "./hukka_hua_2"
    ...
    new_prompt = ["If the given sentence ```I wont be able to eat any food today because i dont have any money``` is posted in any social media, will it violate any rule? If violation is true then which rule is violated and what is the explanation. Your answer must strictly include if violation is true or false."]
    # Generate text
