...
model_list = ["chunked_model_2_128_0.1.pth","chunked_model_2_128_0.001.pth","chunked_model_2_128_0.0001.pth","chunked_model_2_128_0.0005.pth","chunked_model_2_256_0.1.pth","chunked_model_2_256_0.001.pth","chunked_model_2_256_0.0001.pth","chunked_model_2_256_0.0005.pth"]
for i in model_list:
    model = torch.load(i)
    model.eval()
